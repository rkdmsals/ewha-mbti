...
function Test() {
    ...
    const TakeAnswer = (val) => {
        ...
        switch (type) {
            case "EandI": answersArr.type1[val - 1] += 1; break;
            case "NandS": answersArr.type2[val - 1] += 1; break;
            case "TandF": answersArr.type3[val - 1] += 1; break;
            case "PandJ": answersArr.type4[val - 1] += 1; break;
            default: break;
        }
    ...
    return (<div className="TestBackground">
        {page < 6 ? TestData.questions.map((a, idx) =>
