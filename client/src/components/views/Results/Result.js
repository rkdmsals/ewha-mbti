            ...
            <div className="ResultFrame">
                ...
                <div className="ChemistryPage">
                    <div className="Chemistries">
                        ...
                        <img className="ChemiImg" alt="환상의 케미 이미지" src="/img/ResultPage/Building/auditorium.png"></img>
                        <div className="ChemiMiddle">자유로운 영혼</div>
                        <div className="ChemiName">조형예술관</div>
                    </div>
                    <div className="Chemistries">
                        <div className="ChemiTitle">환장의 케미</div>
                        <img className="ChemiImg" alt="환장의 케미 이미지" src="/img/ResultPage/Building/auditorium.png"></img>
                        <div className="ChemiMiddle">자유로운 영혼</div>
                        <div className="ChemiName">조형예술관</div>
                    </div>
                </div>
